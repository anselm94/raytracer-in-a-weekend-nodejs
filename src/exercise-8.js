...
listHitable.push(new Sphere(new Vector(1, 0, -1), 0.5, new Metal(new Vector(0.8, 0.6, 0.2))));
listHitable.push(new Sphere(new Vector(-1, 0, -1), 0.5, new Metal(new Vector(0.8, 0.8, 0.8))));
